...
epsilons = [2.05, 2.1, 2.25, 2.5, 2.75, 3.0]
#alphas = [0.00001, 0.2, 0.5, 0.8, 0.99999]
#k_news = [1, 2, 4, 8]
#q_reuses = [1, 2, 4, 8]
#g_rel_opts = [] # [0.12, 0.15, 0.18] # [0, 0.03, 0.05, 0.08]
run_count = 0
synth_strats = ['patectgan', 'dpctgan', 'pategan', 'mst', 'aim']
# synth_datasets = ['e9b3683c-802e-11ef-ac50-bae7b799ac02', 'ff5593d2-802d-11ef-ac50-bae7b799ac02']
#worsts = [True, False]
#Ts = [0, 1, 5, 10, 15, 25, 50]
for loops in range(10):
    #reset_runner()
    for i, sn in enumerate(synth_strats):
        synth_strat = sn
        runner.update(synth=sn)
        # runner.load_artifacts(synth_datasets[i])
        for eps in epsilons:
            runner.update(epsilon=eps)
            runner.regenerate_qm = True
            runner.regenerate_cross_answers = True
            results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "11IPUMS_MediumPGD_sn_eps" })
            run_count += 1
    ...
    #    runner.regenerate_qm = True
    #    runner.regenerate_cross_answers = True
    #    results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "00IPUMS_MediumPGD_g_in" })
    #    run_count += 1
    #    print(f"eps: {runner.epsilon}, error_ave: {results['error_ave']}")
    #    print(f"###### COMPLETED {run_count} RUNS ######")
    #reset_runner()
    ...
    #     runner.regenerate_qm = True
    #     runner.regenerate_cross_answers = True
    #     results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "-00IPUMS_MediumPGD_q_reuse" })
    #     run_count += 1
    #     print(f"eps: {runner.epsilon}, error_ave: {results['error_ave']}")
    #     print(f"###### COMPLETED {run_count} RUNS ######")
    # reset_runner()
    ...
    #     runner.regenerate_qm = True
    #     runner.regenerate_cross_answers = True
    #     results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "-00IPUMS_MediumPGD_knew" })
    #     run_count += 1
    #     print(f"eps: {runner.epsilon}, error_ave: {results['error_ave']}")
    #     print(f"###### COMPLETED {run_count} RUNS ######")
    # reset_runner()
    ...
    #     runner.regenerate_qm = True
    #     runner.regenerate_cross_answers = True
    #     results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "-00IPUMS_MediumPGD_eps" })
    #     run_count += 1
    #     print(f"eps: {runner.epsilon}, error_ave: {results['error_ave']}")
    #     print(f"###### COMPLETED {run_count} RUNS ######")
    # reset_runner()
    ...
    #     runner.regenerate_qm = True
    #     runner.regenerate_cross_answers = True
    #     results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "-00IPUMS_MediumPGD_alpha" })
    #     run_count += 1
    #     print(f"eps: {runner.epsilon}, error_ave: {results['error_ave']}")
    #     print(f"###### COMPLETED {run_count} RUNS ######")
    # reset_runner()
    ...
    #     runner.regenerate_qm = True
    #     runner.regenerate_cross_answers = True
    #     results = runner.run(extra_params={ "info": make_summary_dict(), "run_set": "-00IPUMS_MediumPGD_worst" })
    #     run_count += 1
    #     print(f"eps: {runner.epsilon}, error_ave: {results['error_ave']}")
    #     print(f"###### COMPLETED {run_count} RUNS ######")
    # reset_runner()