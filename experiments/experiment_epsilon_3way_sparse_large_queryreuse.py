...
def cross_generator_torch(qm, eps_rel, T):
    b_round = dp_relational.lib.synth_data.learn_relationship_vector_torch_masked_query_reuse(qm, eps_rel, T=T, T_mirror=150, subtable_size=200000, verbose=True, device=device)
...
while True:
    for epsilon in epsilons:
        ...
        results = runner.run(extra_params={ "T_mirror": 150, "run_set": 300 })
